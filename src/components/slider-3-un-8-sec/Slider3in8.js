    ...
    if (!this.state.slideChosen) {
      ...
      return (
        <div className="grey-fon">
          <div className="slideshow-exp cen-exp">
            <div className="slides-exp">
              <input type="radio" name="p-exp" id="c1-exp" />
              <input type="radio" name="p-exp" id="c2-exp" />
              <input type="radio" name="p-exp" id="c3-exp" />
              <input type="radio" name="p-exp" id="c4-exp" />
              <input type="radio" name="p-exp" id="c5-exp" />
              <input type="radio" name="p-exp" id="c6-exp" />
              <input type="radio" name="p-exp" id="c7-exp" />
              <input type="radio" name="p-exp" id="c8-exp" />
              <div className="slide-exp pc1-exp">
                <div className="background-image-sl-top">
                  <div className="temp-3">
                    {section1.map((element, index) => {
                      return (
            ...
            <div className="change-exp">
              <label className="tool-exp" htmlFor="c1-exp"></label>
              <label className="tool-exp" htmlFor="c2-exp"></label>
              <label className="tool-exp" htmlFor="c3-exp"></label>
              <label className="tool-exp" htmlFor="c4-exp"></label>
              <label className="tool-exp" htmlFor="c5-exp"></label>
              <label className="tool-exp" htmlFor="c6-exp"></label>
              <label className="tool-exp" htmlFor="c7-exp"></label>
              <label className="tool-exp" htmlFor="c8-exp"></label>
            </div>
          </div>
        </div>
      );
